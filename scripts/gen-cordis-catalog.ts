...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  RemoteHostRow: 'remote host summary row is owned by packages/remote/remote-hosts/README.md',
  RemoteHostAddInput: 'remote host write input is owned by packages/remote/remote-hosts/README.md',
  RemoteHostConnection: 'resolved tunnel connection is owned by packages/remote/remote-hosts/README.md',
