...
| `ctx.desktopRuntime` | `core` | [`desktop-runtime`](../packages/desktop/runtime) | - | - | - | Owns Electron-window request dispatch, fixed host and mux downlinks, and renderer request cancellation without a network listener. |
